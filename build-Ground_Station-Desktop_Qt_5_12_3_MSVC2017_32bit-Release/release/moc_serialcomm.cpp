...
#include "../../Ground_Station_source/serialcomm.h"
...
QT_MOC_LITERAL(4, 23, 12), // "responseData"
QT_MOC_LITERAL(5, 36, 8), // "finished"
QT_MOC_LITERAL(6, 45, 12), // "setup_serial"
QT_MOC_LITERAL(7, 58, 8), // "portName"
QT_MOC_LITERAL(8, 67, 8), // "baudrate"
QT_MOC_LITERAL(9, 76, 19) // "read_serial_message"

    },
    "SerialComm\0response\0\0s\0responseData\0"
    "finished\0setup_serial\0portName\0baudrate\0"
    "read_serial_message"
};
...
void SerialComm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->response((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        case 1: _t->finished(); break;
        case 2: _t->setup_serial((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: { QByteArray _r = _t->read_serial_message();
        ...
        {
            using _t = void (SerialComm::*)(const QString & , QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialComm::response)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialComm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialComm::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialComm::response(const QString & _t1, QByteArray _t2)
{
